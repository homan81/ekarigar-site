...
export default function Header() {
  ...
  return (
    <header
      className={`bg-white main-header fixed top-0 left-0 w-full z-50 transition-transform duration-500 ${
    ...
    >
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="h-[322px] lg:hidden" role="dialog" aria-modal="true">
          <div
            className="fixed inset-0 z-40 bg-black/20"
            onClick={() => setMobileMenuOpen(false)}
          ></div>
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm transition-transform duration-500">
            <div className="flex items-center justify-between">
              <Link href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Your Company</span>
                <Image
            ...
            <div className="mt-6">
              ...
              <Link
                href="#"
                className="email-slider flex items-center gap-2 rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50"
              >
